(function () {
  ...
  function handleSubmit() {
    ...
    if (!record) {
      errorEl.textContent = 'Nenhum certificado encontrado. Verifique os dados e tente novamente.';
      errorEl.hidden = false;
      return;
    }
  ...
  function preencherCertificado(record) {
    ...
    document.getElementById('cert-paragrafo').innerHTML =
      'Por participar e concluir com aproveitamento o <b>Curso/Treinamento</b> <b>' + escapeHtml(record.curso) + '</b> ' +
